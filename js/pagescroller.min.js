        ...
        pageScroller: function(f) {
            ...
            pageScroll = function(d, a) {
                ...
                pageScroller.sections.each(function(b) {
                   ...
                   /*右侧小点提示*/
                   function foodIndex(){
                    	$('.scrollNav a').on('mousemove',function(){
                    		var foodarry = ['无肉不欢','素食达人','家的味道'];
                    		$(this).attr('title',foodarry[$('.scrollNav a').index(this)]);
							console.log(foodarry[$('.scrollNav a').index(this)])
